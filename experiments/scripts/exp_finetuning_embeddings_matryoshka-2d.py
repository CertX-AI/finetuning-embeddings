"""
exp_finetune_embeddings_mnrl_matryoshka-2d.py
...
from finetuning_embeddings.embedding_utils import (
    ...
    get_symm_MNRL_or_matryoshka2d_loss,
...
# ------------------------------------------------------------------
LOSS_MAPPING = {
    "MultipleNegativesRankingLoss":                get_MNRL_or_matryoshka2d_loss,
    "MultipleNegativesSymmetricRankingLoss":       get_symm_MNRL_or_matryoshka2d_loss,
}
    ...
    with mlflow.start_run():
       ...
       # 3. Define the MNRL loss function
        ...
        try:
            ...
            loss_fn = get_MNRL_or_matryoshka2d_loss            # default
